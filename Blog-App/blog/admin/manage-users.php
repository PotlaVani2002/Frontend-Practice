...
session_start();
//  Fetch users from the database, excluding the current admin
$current_adminid = $_SESSION['user-id'];
$query = "SELECT * FROM users WHERE NOT id=$current_adminid";
$users = mysqli_query($connection, $query);
?>

<section class="dashboard">
    <?php
    // Check if any success messages are set and display them
    if (isset($_SESSION['add-user-success']) || isset($_SESSION['edit-user-success'])) : ?>
    ...
    <?php elseif (isset($_SESSION['edit-user'])): ?>
        ...
        <!-- shows if delete user was not successful -->
    <?php elseif (isset($_SESSION['delete-user'])): ?>
        ...
        <!-- shows if delete user was successful -->
